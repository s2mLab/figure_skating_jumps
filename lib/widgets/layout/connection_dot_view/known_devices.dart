...
class _KnownDevicesState extends State<KnownDevices> {
  ...
  @override
  void initState() {
    stateIconConnected = const XSensStateIcon(true, XSensDeviceState.connected);
            ...
            Container(
                ...
                child: Container(
                  ...
                  child: XSensDotListElement(
                      ...
                      text:
                          XSensDotConnectionService().currentXSensDevice == null
                              ? "No device"
                        ...
                        final result = await showDialog(
                            ...
                            builder: (BuildContext context) {
                              return ConfigureXSensDotDialog(
                                xSensDot: XSensDotBluetoothDiscoveryService()
                                    .getDevices()[0],
                                close: () {
            ...
            Container(
                ...
                child: XSensDotListElement(
                  ...
                  text: XSensDotBluetoothDiscoveryService()
                      .getDevices()[0]
                      .assignedName,
                  // TODO: Change for autogenerated list when DB available
