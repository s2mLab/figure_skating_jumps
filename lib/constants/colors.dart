...
const primaryColorDark = Color(0xFF09386D); // Use sparingly, not an official color - thin strokes...

const secondaryLight = Color(0xFFF6D268); // Use sparingly, not an official color.
...
const paleText = Color(0xFFFAFAFA); // White text
